...
TOOL_DATA.statePlaybook = {
  ...
  states: [
    ...
    { state:"D-SNP / MA supplemental (nationwide)", tier:"1 — NOW (faster cycles)", mechanism:"SSBCI (three-prong chronically-ill gate, documented) + supplemental benefits; VBID's broad food path terminated end-2025, making SSBCI the dominant channel", rate:"Plan-negotiated — margins healthier than Medicaid ILOS per-meal rates", cookunity:"Natural fit: member-experience edge monetizes directly against Stars/CAHPS", whyNow:"Faster contracting cycles than Medicaid procurement; mid-year unused-benefit notices (first wave June 30–July 31, 2026) are spiking member engagement conversations right now.", play:"Sell the SSBCI qualification event as a documented screen wired to an intervention; Stars/HEDIS/CAHPS framing; the adherence edge is the pitch." },
